...
static const _register_t _def [] =
{
    ...
    [SENSOR_0_NAME_LIST]        =   {0xf400,    R_SENSOR_0_NAMELIST,        4, RD,      164},
    [SENSOR_0_IPSO_TYPE]        =   {0xf454,    R_SENSOR_0_IPSO_TYPE,       4, RD,     sizeof(uint16_t)},
    [SENSOR_0_PRECISION]        =   {0xf455,    R_SENSOR_0_PRECISION,       4, RD,     sizeof(uint16_t)},
    [SENSOR_0_FUNCTION]         =   {0xf456,    0x00,                       4, RD,     sizeof(uint16_t)},
    [SENSOR_0_MIN_VALUE]        =   {0xf458,    R_SENSOR_0_MINVALUE,        4, RD,     sizeof(float)},
    [SENSOR_0_MAX_VALUE]        =   {0xf45a,    R_SENSOR_0_MAXVALUE,        4, RD,     sizeof(float)},
    [SENSOR_0_MIN_RANGE]        =   {0xf45c,    R_SENSOR_0_MINRANGE,        4, RD,     sizeof(float)},
    [SENSOR_0_MAX_RANGE]        =   {0xf45e,    R_SENSOR_0_MAXRANGE,        4, RD,     sizeof(float)},
    [SENSOR_0_PARAM_0_VALUE]    =   {0xf460,    R_SENSOR_0_PARAMETER_0,     4, RD|WR,  sizeof(float)},
    [SENSOR_0_PARAM_0_MIN]      =   {0xf462,    0x00,                       4, RD,     sizeof(float)},
    [SENSOR_0_PARAM_0_MAX]      =   {0xf464,    0x00,                       4, RD,     sizeof(float)},
    [SENSOR_0_PARAM_0_INCREMENT]=   {0xf466,    0x00,                       4, RD,     sizeof(float)},
    [SENSOR_0_PARAM_1_VALUE]    =   {0xf468,    R_SENSOR_1_PARAMETER_1,     4, RD|WR,  sizeof(float)},
    [SENSOR_0_PARAM_1_MIN]      =   {0xf46a,    0x00,                       4, RD,     sizeof(float)},
    [SENSOR_0_PARAM_1_MAX]      =   {0xf46c,    0x00,                       4, RD,     sizeof(float)},
    [SENSOR_0_PARAM_1_INCREMENT]=   {0xf46e,    0x00,                       4, RD,     sizeof(float)},
    [SENSOR_0_PARAM_2_VALUE]    =   {0xf470,    R_SENSOR_2_PARAMETER_1,     4, RD|WR,  sizeof(float)},
    [SENSOR_0_PARAM_2_MIN]      =   {0xf472,    0x00,                       4, RD,     sizeof(float)},
    [SENSOR_0_PARAM_2_MAX]      =   {0xf474,    0x00,                       4, RD,     sizeof(float)},
    [SENSOR_0_PARAM_2_INCREMENT]=   {0xf476,    0x00,                       4, RD,     sizeof(float)},
    [SENSOR_0_PARAM_3_VALUE]    =   {0xf478,    R_SENSOR_3_PARAMETER_1,     4, RD|WR,  sizeof(float)},
    [SENSOR_0_PARAM_3_MIN]      =   {0xf47a,    0x00,                       4, RD,     sizeof(float)},
    [SENSOR_0_PARAM_3_MAX]      =   {0xf47c,    0x00,                       4, RD,     sizeof(float)},
    [SENSOR_0_PARAM_3_INCREMENT]=   {0xf47e,    0x00,                       4, RD,     sizeof(float)},
