...
static const _register_t _def [] =
{
    ...
    [DEVICE_NAME_LIST]          =   {0xf0a0,    R_IO_DEVICE_LIST_NAMES,         1, RD|BYTES,      sizeof(device_name_list_t)},
	[DEVICE_MODEL_NAME]          =   {0xf0a0,    R_IO_DEVICE_LIST_NAMES,         1, RD|BYTES,      sizeof(device_model_name_t)},
