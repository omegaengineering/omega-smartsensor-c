...
static const _register_t _def [] =
{
    ...
    [SENSOR_0_NAME]             =   {0xf700,    R_SENSOR_0_NAME ,               4,  RD|WR|BYTES,     16},
    [SENSOR_1_NAME]             =   {0xf708,    R_SENSOR_1_NAME,                3,  RD|WR|BYTES,     16},
    [SENSOR_2_NAME]             =   {0xf710,    R_SENSOR_2_NAME,                2,  RD|WR|BYTES,     16},
    [SENSOR_3_NAME]             =   {0xf718,    R_SENSOR_3_NAME,                1,  RD|WR|BYTES,     16},
