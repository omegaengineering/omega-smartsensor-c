...
static const _register_t _def [] =
{
    ...
    [SENSOR_0_NAME]             =   {0xf700,    R_SENSOR_0_NAME ,               4,  RD|WR,     16},
    [SENSOR_1_NAME]             =   {0xf708,    R_SENSOR_1_NAME,                3,  RD|WR,     16},
    [SENSOR_2_NAME]             =   {0xf710,    R_SENSOR_2_NAME,                2,  RD|WR,     16},
    [SENSOR_3_NAME]             =   {0xf718,    R_SENSOR_3_NAME,                1,  RD|WR,     16},
    [OUTPUT_0_NAME]             =   {0xf720,    R_OUTPUT_0_NAME,                4,  RD|WR,     16},
    [OUTPUT_1_NAME]             =   {0xf728,    R_OUTPUT_1_NAME,                3,  RD|WR,     16},
    [OUTPUT_2_NAME]             =   {0xf730,    R_OUTPUT_2_NAME,                2,  RD|WR,     16},
    [OUTPUT_3_NAME]             =   {0xf738,    R_OUTPUT_3_NAME,                1,  RD|WR,     16},
